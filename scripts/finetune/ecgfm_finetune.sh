...
CKPT_PATH="~/autodl-tmp/logs/melp/ckpts/melp_ecgfm_2025_12_23_15_35_24/epoch=44-step=131040.ckpt"
# ==================================
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name anzhen \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name ptbxl_super_class \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name ptbxl_sub_class \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name ptbxl_form \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name ptbxl_rhythm \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name icbeb \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name ecgfm --dataset_name chapman \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
    --lr 1e-5
