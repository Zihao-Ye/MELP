...
CKPT_PATH="~/autodl-tmp/logs/melp/ckpts/melp_melp_2025_12_20_16_26_48/epoch=14-step=43680.ckpt"
# ==================================
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name melp --dataset_name anzhen \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name melp --dataset_name ptbxl_sub_class \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name melp --dataset_name ptbxl_form \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name melp --dataset_name ptbxl_rhythm \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python main_finetune.py \
    --model_name melp --dataset_name chapman \
    --train_data_pct 0.01 \
    --ckpt_path $CKPT_PATH \
    --num_devices 4
